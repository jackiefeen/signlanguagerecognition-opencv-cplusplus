...
prepare_train_data(const Mat& data, const Mat& responses, int ntrain_samples)
{
    ...
    int nvars = data.cols;
    //
    cout << "number of input variables" << nvars << endl;
                      ...
                      const string& filename_to_load )
{
    ...
    else
    {
        ...
        // 2. train classifier
        // I chose to set the architecture of the MLP to 8,4
        int layer_sz[] = { data.cols, 8, 4, class_count };
        int nlayers = (int)(sizeof(layer_sz)/sizeof(layer_sz[0]));
        Mat layer_sizes( 1, nlayers, CV_32S, layer_sz );
        cout << "The number of layers used is: " << nlayers << endl;
        cout << "And the sizes of the layers: " << layer_sz[0] << ", " << layer_sz[1] << ", " << layer_sz[2] << ", " << layer_sz[3] << endl;
